...
class Media():
    ...
    def __init__(self, title, story_line, poster_image_url, trailer_youtube_url, year):
        self.title = title
...
class Movie(Media):
    ...
    def __init__(self, title, story_line, poster_image_url, trailer_youtube_url, year, duration):
...
class TVShow(Media):
    ...
    def __init__(self, title, story_line, poster_image_url, trailer_youtube_url, year, seasons_count):
        Media.__init__(self, title, story_line,
                       poster_image_url, trailer_youtube_url, year)
